...
public class LibraryUI extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        mainLayout.setStyle(
                "-fx-background-color: linear-gradient(to bottom right, #f8fafc, #e0e7ef); -fx-background-radius: 20;");
    ...
    private VBox createLeftPanel() {
        ...
        panel.setStyle(
                "-fx-background-color: white; -fx-background-radius: 18; -fx-effect: dropshadow(gaussian, #cfd8dc, 10, 0.2, 0, 2);");
        ...
        bookSearchField.setStyle(
                "-fx-font-size: 14px; -fx-background-radius: 8; -fx-padding: 6 12 6 12; -fx-border-color: #b0bec5; -fx-border-radius: 8;");
        ...
        newItemButton.setStyle(
                "-fx-background-color: #4f8cff; -fx-text-fill: white; -fx-font-weight: bold; -fx-background-radius: 7; -fx-padding: 6 18 6 18;");
        ...
        deleteBookButton.setStyle(
                "-fx-background-color: #ff5e5b; -fx-text-fill: white; -fx-font-weight: bold; -fx-background-radius: 7; -fx-padding: 6 18 6 18;");
    ...
    private VBox createMiddlePanel() {
        ...
        borrowButton.setStyle(
                "-fx-background-color: #43b581; -fx-text-fill: white; -fx-font-weight: bold; -fx-background-radius: 7; -fx-padding: 8 0 8 0;");
        Button returnButton = new Button("<<<< Return");
        returnButton.setPrefWidth(140);
        returnButton.setStyle(
                "-fx-background-color: #f5a623; -fx-text-fill: white; -fx-font-weight: bold; -fx-background-radius: 7; -fx-padding: 8 0 8 0;");
    ...
    private void returnSelectedBook() {
        ...
        if (successCount > 0) {
            ...
            safeShowError("Return Failed",
                    "Could not return any of the selected books. They may be unavailable or already returned.");
        }
    }
    ...
    public static class BookData {
        ...
        public BookData(Map<String, Object> data) {
            ...
            this.publicationYear = data.get("publication_year") != null
                    ? ((Number) data.get("publication_year")).intValue()
                    : 0;
    ...
    public static class AuthorData {
        ...
        public AuthorData(Map<String, Object> data) {
            ...
            this.birthYear = data.get("birth_year") != null ? ((Number) data.get("birth_year")).intValue() : 0;
